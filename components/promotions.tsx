...
const WHATSAPP_NUMBER = "573176614939"
  ...
  useEffect(() => {
    fetch("/api/products?limit=50")
      ...
      .then((data) => {
        ...
        setPromotions(list.filter((p: Product) => p.is_promotion))
      })
      .catch(() => setPromotions([]))
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="mb-16 text-center">
          <span className="mb-6 inline-flex items-center gap-3 rounded-full border border-neon/50 bg-gradient-to-r from-neon/20 via-neon/10 to-neon/20 px-6 py-2.5 text-sm font-medium text-neon backdrop-blur-sm animate-neon-pulse">
            ...
            <span className="tracking-wider uppercase">Ofertas Especiales para ustedes</span>
            ...
            {promotions.map((promo, index) => (
              ...
              >
                ...
                <div className="relative rounded-xl bg-gradient-to-br from-card via-background to-card p-6">
                  ...
                  <a
                    href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(`Hola, me interesa la promoción: ${promo.name}`)}`}
                    target="_blank"
